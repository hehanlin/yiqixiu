...
<body>
	...
	<div class="tu"><img src="<present name="message">/tpl/static/success.png<else/>/tpl/static/error.png</present>"><div class="msg" style="margin-top:15px"><present name="message"><?php echo($message); ?><else/><?php echo($error); ?></present></div><div class="msg" style="color:#999999;font-size:12px"><span id="wait"><?php echo($waitSecond); ?></span>秒后自动跳转<a id="href" style="display:block; color:red" href="<?php echo($jumpUrl); ?>">点击手动跳转</a></div></div>
